...
WAN_BOXES="103.22.221.170 0 202.90.150.4 0 203.191.48.228 103.22.221.31 161.200.25.99 140.116.214.241 203.80.21.4 103.26.47.228 103.22.221.30 103.22.221.62"
...
function check_box_bandwidth {
	...
	echo -e "\n"
        ...
        echo -e "------------------------------------------------------------"
#        iperf3 -s -p 30000 &
	ping -q -c2 103.22.221.56 > /dev/null
...
python /home/tein/active_monitoring/check_daily_report.py "ping_latency" "$FROM_BOX_SITE" "$ping_grid" "$latency_grid" "$vcenter_check"  > /home/tein/active_monitoring/result/PING_LATENCY_RESULT_WAN_BOX.log 2>&1
